                      ...
                      children: [
                        ...
                        Obx(() => controller.role.value == AppConstants.superAdmin
                            ...
                            : FixedTextField(
                                enable: false,
                                function: (v) {},
                                label: trap!.serialNumber!
                                    .substring(trap!.serialNumber!.length - 5),
                              )),
                        SizedBox(
                          height: Dimensions.height * 0.03,
                        ),
                                ...
                                children: [
                                  CustomMultiSelect(
                                    ...
                                    onConfirm: (values) {
                                      for (var element in values) {
                                        ...
                                        controller.slideRangeScheduleFan.where(
                                            (element) =>
                                                element.status == value);
                                      }

                                      print(controller
                                          .slideRangeScheduleFan.length);
                                      for (var element
                                  ...
                                  CustomMultiSelect(
                                    ...
                                    onConfirm: (values) {
                                      ...
                                      print(controller
                                          .slideRangeScheduleCounter.length);
                                      for (var element in controller
                                          .slideRangeScheduleCounter) {
                                        print(element.status);
                                      }
                                    },
                                  ),
                                  ...
                                  CustomMultiSelect(
                                    ...
                                    onConfirm: (values) {
                                      ...
                                      print(controller
                                          .slideRangeScheduleValueQut.length);
                                      for (var element in controller
                                          .slideRangeScheduleValueQut) {
                                        print(element.status);
                                      }
                                    },
                                  ),
