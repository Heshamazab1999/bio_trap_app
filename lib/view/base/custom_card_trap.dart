                      ...
                      Row(
                        children: [
                          ...
                          CustomCircleIndicator(
                            percent: double.parse(fan ?? "0.0") / 100,
                            percentText: "${double.parse(fan ?? "0.0")}%",
                          ),
                        ],
                      ),
                      SizedBox(
                        ...
                        children: [
                          Text(AppConstants.valveQut,
                              style: robotoMedium.copyWith(
                                  ...
                                  fontSize: Dimensions.fontSizeLarge)),
                          CustomCircleIndicator(
                            percent: double.parse(valueQut ?? "0.0") / 100,
                            percentText: " ${double.parse(valueQut ?? "0.0")}%",
                          ),
                        ],
                      ),
                    ],
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Image.asset(
                              working! ? Images.checkIcon : Images.crossIcon,
                              height: 25),
                          const SizedBox(
                            width: 5,
                          ),
                          Text(
                            working! ? AppConstants.oN : AppConstants.off,
                            style: robotoMedium.copyWith(
                                fontSize: Dimensions.fontSizeLarge,
                                color: working!
                                    ? Colors.green
